...
if(WIN32)
    ...
    if(WITH_OPENCV)
        ...
        file( COPY "${OpenCV_BIN}/opencv_core${ocvs}"               DESTINATION "${_tdest}")
        file( COPY "${OpenCV_BIN}/opencv_dnn${ocvs}"                DESTINATION "${_tdest}")
        file( COPY "${OpenCV_BIN}/opencv_calib3d${ocvs}"            DESTINATION "${_tdest}")
        file( COPY "${OpenCV_BIN}/opencv_highgui${ocvs}"            DESTINATION "${_tdest}")
        file( COPY "${OpenCV_BIN}/opencv_imgcodecs${ocvs}"          DESTINATION "${_tdest}")
        file( COPY "${OpenCV_BIN}/opencv_imgproc${ocvs}"            DESTINATION "${_tdest}")
        file( COPY "${OpenCV_BIN}/opencv_objdetect${ocvs}"          DESTINATION "${_tdest}")
        file( COPY "${OpenCV_BIN}/opencv_features2d${ocvs}"         DESTINATION "${_tdest}")
        file( COPY "${OpenCV_BIN}/opencv_flann${ocvs}"              DESTINATION "${_tdest}")
        file( COPY "${OpenCV_BIN}/opencv_surface_matching${ocvs}"   DESTINATION "${_tdest}")
        file( COPY "${OpenCV_BIN}/opencv_videoio${ocvs}"            DESTINATION "${_tdest}")
    ...
    if(WITH_VTK)
        ...
        file( COPY "${VTK_BIN}/vtkFiltersHyperTree${vtks}"            DESTINATION "${_tdest}")
        ...
        file( COPY "${VTK_BIN}/vtkRenderingHyperTreeGrid${vtks}"      DESTINATION "${_tdest}")
    ...
    if(WITH_QUAZIP)
        ...
        file( COPY "${QuaZip-Qt5_DIR}/../../../bin/quazip1-qt5.dll" DESTINATION "${_tdest}")
    endif()

    if(WITH_ZLIB)
        file( COPY "${ZLIB_ROOT}/bin/zlib.dll" DESTINATION "${_tdest}")
    endif()
    ...
    if(WITH_QT)
        ...
        file( COPY "${QT_BIN}/../plugins/imageformats/qicns${_dsuffix}.dll" DESTINATION "${_tdest}/imageformats")
        file( COPY "${QT_BIN}/../plugins/imageformats/qwbmp${_dsuffix}.dll" DESTINATION "${_tdest}/imageformats")
        file( COPY "${QT_BIN}/../plugins/imageformats/qgif${_dsuffix}.dll" DESTINATION "${_tdest}/imageformats")
        file( COPY "${QT_BIN}/../plugins/imageformats/qwebp${_dsuffix}.dll" DESTINATION "${_tdest}/imageformats")
        file( COPY "${QT_BIN}/../plugins/imageformats/qtiff${_dsuffix}.dll" DESTINATION "${_tdest}/imageformats")
        file( COPY "${QT_BIN}/../plugins/imageformats/qtga${_dsuffix}.dll" DESTINATION "${_tdest}/imageformats")
        file( COPY "${QT_BIN}/../plugins/imageformats/qjpeg${_dsuffix}.dll" DESTINATION "${_tdest}/imageformats")
    ...
    if( IS_DEBUG)
        set( C_DLL_DIR "${MSVC_REDIST}/Debug_NonRedist/x64/Microsoft.VC${MSVC_TOOLSET_VERSION}.DebugCRT")
    else()
        set( C_DLL_DIR "${MSVC_REDIST}/x64/Microsoft.VC${MSVC_TOOLSET_VERSION}.CRT")
    endif()
    ...
    file( GLOB UCRT_DLLS "$ENV{WindowsSDKDir}/Redist/$ENV{ucrtversion}/ucrt/DLLs/x64/*.dll")
