...
if(WIN32)
    ...
    if(WITH_QT)
        ...
        file( COPY "${QT_BIN}/Qt5Core.dll"    DESTINATION "${tdest}")
        file( COPY "${QT_BIN}/Qt5GUI.dll"     DESTINATION "${tdest}")
        file( COPY "${QT_BIN}/Qt5Widgets.dll" DESTINATION "${tdest}")
        file( COPY "${QT_BIN}/Qt5SQL.dll"     DESTINATION "${tdest}")
    endif()
